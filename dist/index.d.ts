export type { ProsodyFeatures, AcousticProvenance, AcousticStateValues, AcousticStateMasks, AcousticStateFrames, AcousticState, AcousticChangeValues, AcousticChange, TurnProsody, KPIOutcomeEntry, ProsodyTrajectory, ProsodyTimelinePoint, PerSpeakerAnalysis, DiarizedSpeaker, SpeakerIdentity, SpeakerProfile, SpeakerDirectoryEntry, SpeakerDirectoryResult, VoiceEnrollmentLane, VoiceEnrollmentPreview, VoiceEnrollmentMapping, VoiceEnrollmentResult, DiarizationTurn, DiarizationResult, AnalysisTurn, AnalysisEvent, TurnBoundary, AnalysisResult, TranscriptionStatus, TranscriptSegment, TranscriptTurn, SessionTranscript, AnalysisOptions, FeedbackCorrectionOptions, SessionOutcomeOptions, PCMOptions, DiarizationSegment, ProsodyEmbedding, ProsodyEventType, ProsodyEventEnvelope, AffectReading, DirectiveEvent, TranscriptWord, TranscriptUpdateSegment, TranscriptUpdateEvent, SpeakerUpdateEvent, SpeakerProfilesEvent, StateDeltaEvent, TurnBoundaryEvent, BargeInEvent, SessionDiagnostic, SessionEndEvent, WarningEvent, ServerErrorEvent, ProsodyEvent, } from './types.js';
