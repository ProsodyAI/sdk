export type { ProsodyConfig, ProsodyMarkers, ProsodyFeatures, ProsodySignals, AcousticProvenance, AcousticStateValues, AcousticStateMasks, AcousticStateFrames, AcousticState, AcousticChangeValues, AcousticChange, TurnProsody, KPIImpactFactor, KPIRecommendedAction, KPIAlertResult, KPIPredictionResult, KPIOutcomeEntry, ProsodyTrajectory, ProsodyTimelinePoint, ProsodySummary, PerSpeakerAnalysis, DiarizedSpeaker, SpeakerIdentity, SpeakerProfile, SpeakerDirectoryEntry, SpeakerDirectoryResult, VoiceEnrollmentSegment, VoiceEnrollmentCluster, VoiceEnrollmentPreview, VoiceEnrollmentMapping, VoiceEnrollmentResult, CallInsight, AnalysisAlert, RecommendedAction, DiarizationTurn, DiarizationResult, AnalysisTurn, AnalysisResult, TranscriptSegment, TranscriptTurn, SessionTranscript, AnalysisOptions, FeedbackCorrectionOptions, SessionOutcomeOptions, PCMOptions, ModulationMode, ModulationTts, AgentModulation, ForwardPrediction, DiarizationSegment, SpeakerMerge, ProsodyEmbedding, ProsodyEventType, ProsodyEventEnvelope, DirectiveEvent, TranscriptUpdateSegment, TranscriptUpdateEvent, SpeakerUpdateEvent, SpeakerClusterUpdateEvent, SpeakerProfilesEvent, AgentSteeringEvent, InsightsUpdateEvent, SessionDiagnostic, SessionEndEvent, WarningEvent, ServerErrorEvent, ProsodyEvent, } from './types.js';
